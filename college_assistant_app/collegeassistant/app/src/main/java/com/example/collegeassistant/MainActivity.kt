...
class MainActivity : ComponentActivity(), TextToSpeech.OnInitListener {
    ...
    private val showAvatar = mutableStateOf(false)
    ...
    private fun restartListening(delayMillis: Long = 500) {
        ...
        Handler(Looper.getMainLooper()).postDelayed({
            val intent = Intent(RecognizerIntent.ACTION_RECOGNIZE_SPEECH).apply {
                ...
                putExtra(RecognizerIntent.EXTRA_LANGUAGE, if (selectedLang.value == "hi") "hi-IN" else "en-US")
            ...
            Scaffold(
                ...
                Column(
                    ...
                    Row(verticalAlignment = androidx.compose.ui.Alignment.CenterVertically) {
                        ...
                        LanguageDropdown(selectedLang.value) {
                            selectedLang.value = it
                            updateTTSLanguage(it)
                        }
                        Spacer(Modifier.width(16.dp))
                        if (isListening.value) {
                            Text("🎤 Listening...", color = MaterialTheme.colorScheme.primary)
                        } else {
                            Text("🛑 Not listening", color = MaterialTheme.colorScheme.onSurfaceVariant)
                        }
                    }
                    ...
                    AndroidView(
                        factory = {
                            LottieAnimationView(it).apply {
                                setAnimation(R.raw.avatar_animation)
        ...
        AlertDialog(
            ...
            text = {
                OutlinedTextField(
                    ...
                    placeholder = { Text("https://yourserver.ngrok.app/") },
                    singleLine = true,
    ...
    @Composable
    fun LanguageDropdown(selectedLang: String, onLangSelected: (String) -> Unit) {
                ...
                options.forEach { lang ->
                    DropdownMenuItem(
                        ...
                        onClick = {
                            ...
                            Toast.makeText(
                                context,
                                "Language set to ${if (lang == "hi") "Hindi" else "English"}",
                                Toast.LENGTH_SHORT
                            ).show()
                            expanded = false
                        }
